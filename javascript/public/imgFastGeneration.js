function fastGenerator(data, colorMapper, imgType){
    if(data){
      // console.log(data);
         ...
         // console.log(value);
          ...
          if(colorMapper){
            ...
            imgData.data[pos+3] = 200;            
              ...
              else if(value>=1000 && value <1700){
                colorThreshold = [173, 221, 142];
              }
              else if(value>=1700){
                colorThreshold = [49, 163, 84];
              }
              imgData.data[pos] = colorThreshold[0];
              imgData.data[pos+1] = colorThreshold[1];
              imgData.data[pos+2] = colorThreshold[2];
